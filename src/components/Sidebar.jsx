...
const Sidebar = () => {
    ...
    return (
        <>
            <nav
                className="fixed top-0 left-0 w-full h-full border-r border-r-gray-200 bg-white space-y-8 sm:w-64">
                <div className="flex flex-col h-full">
                    <div className='h-20 flex items-center px-8'>
                        <NavLink to='/' className='flex items-center -ml-7'>
                            <img src="./src/assets/logo.png" width={70} />
                            <div
                            className="bg-clip-text pb-4 text-xl -ml-2 text-transparent font-bold bg-gradient-to-br from-[#62BDFF] to-[#0094FF]">
                            the.weather
                            </div>
                        </NavLink>
                    </div>
                            ...
                            <ul className="px-4 pb-4 text-sm font-medium">
                                {
                                    navsFooter.map((item, idx) => (
                                        <li key={idx}>
                                            <NavLink to={item.to} className="flex items-center gap-x-2 text-gray-600 p-2 rounded-lg  hover:bg-gray-50 active:bg-gray-100 duration-150">
